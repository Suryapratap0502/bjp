...
<div class="main-content">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Panachayat Samiti</h4>
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="<?php base_url() ?>Dashboard">Dashboards</a></li>
                                <li class="breadcrumb-item active">Panachayat Samiti</li>
                            </ol>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-header align-items-center d-flex">
                            <h4 class="card-title mb-0 flex-grow-1">Panachayat Samiti</h4>
                            <div class="flex-shrink-0">
                                <?php if ($this->rbac->hasPrivilege('panchayat_samiti', 'can_add')) { ?>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalgridLabel">Add New Panachayat Samiti</h5>
                                            ...
                                            <div class="row g-3">
                                                <div class="col-xxl-6">
                                                    <div>
                                                        ...
                                                        <input type="text" class="form-control" name="pan_sam_name" id="pan_sam_name" placeholder="Enter Panchayat Samiti Name">
                                                    </div>
                                ...
                                <div class="table-responsive table-card">
                                    <table class="table align-middle table-nowrap mb-0" id="Datatable1" class="display">
                                        ...
                                        <tbody>
                                            <?php
                                            $i = 1;
                                            foreach ($panchayatsamiti as $row) {
                                            ?>
                                                <tr id="delete">
    ...
    <div class="modal fade" id="editsubadmin" tabindex="-1" aria-labelledby="exampleModalgridLabel" aria-modal="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalgridLabel">Edit Panchyat Samiti</h5>
...
<script type="text/javascript">
    function archiveFunction(id) {
        ...
        swal({
                title: "Are you sure?",
                text: "Delete Panchayat Samiti Record ",
                type: "warning",
            ...
            function(isConfirm) {
                if (isConfirm) {
                    $.ajax({
                        url: "<?= base_url() ?>panchayatsamiti/delete/id",
                        type: "post",
                        data: {
                            id: id
                        },
...
<script>
    ...
    $(document).on('submit', '#addSubadmin', function(ev) {
        ...
        if (error == false) {
            $.ajax({
                url: "<?= base_url('panchayatsamiti/addpanchayatsamiti'); ?>",
                type: 'post',
                data: formData,
                success: function(result) {
                    ...
                    if (dataResult.done == '1') {
                        swal('Panchayat Samiti Added 🙂', ' ', 'success');
                        setTimeout(function() {
...
<script type="text/javascript">
    $(document).ready(function() {
        $('.editmodel').click(function() {
            ...
            $.ajax({
                url: "<?= base_url('panchayatsamiti/panchyatasamitiedit'); ?>",
                type: "post",
                data: {
                    id: userid
                },
...
<script type="text/javascript">
    ...
    $(document).on('submit', '#bannerModelSubmits', function(ev) {
        ...
        var formData = new FormData(this);
        $.ajax({
            url: "<?= base_url() ?>Panchayatsamiti/updatepanchayatsamiti/",
            type: 'post',
            data: formData,
            success: function(result) {
                //json data
