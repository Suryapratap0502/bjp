...
<div class="main-content">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Gram</h4>
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="<?php base_url() ?>Dashboard">Dashboards</a></li>
                                <li class="breadcrumb-item active">Gram</li>
                            </ol>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card">
                        <div class="card-header align-items-center d-flex">
                            ...
                            <div class="flex-shrink-0">
                                <?php if ($this->rbac->hasPrivilege('gram_name', 'can_add')) { ?>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalgridLabel">Add New Gram</h5>
                                            ...
                                            <div class="row g-3">
                                               <div class="col-xxl-6">
                                                ...
                                                <div class="col-xxl-6">
                                                    ...
                                                    <?php foreach ($grampanchayat as $data1) {
                                                                                ?>
                                                    <option value="<?= $data1['id']; ?>"><?php echo $data1['gram_panchyat'];  ?></option>
                                                                                <?php } ?>
                                                    </select>
                                                    </div>
                                             ...
                                             <div class="col-xxl-6">
                                              <div>
                                                  ...
                                                  <input type="text" name="gram_name" class="form-control" id="gram_name" placeholder="Enter Gram Name">
                                              </div>
                                ...
                                <div class="table-responsive table-card">
                                    <table class="table align-middle table-nowrap mb-0" id="Datatable1" class="display">
                                        ...
                                        <tbody>
                                            <?php
                                            $i = 1;
                                            foreach ($gramdata as $row) {
                                            ?>
                                                <tr id="delete">
                                                    <td><a href="#" class="fw-medium"><?php echo $offset++; ?></a></td>
                                                    <td> <?php $id =  $row['panchayatsimit']; 
                                                 ...
                                                 $this->db->select('*');
                                                  ...
                                                  $this->db->where('id',$id);
                                                   ...
                                                   <td> <?php $id1 =  $row['grampanchyat_id']; 
                              ...
                              <div class="align-items-center mt-4 pt-2 justify-content-between d-flex">
                                                    <div class="flex-shrink-0">
                                                        <div class="text-muted">
                                                            Showing <span class="fw-semibold"><?=count($gramdata)?> - <?= isset($count) ? $count : ''; ?></span> Results
                                                        </div>
                                                    </div>
                                                    <ul class="pagination pagination-separated pagination-sm mb-0">
                                                      	<?php $uri = $this->uri->segment(3);  if($uri > 1) { ?>
                                                          <li class="page-item">
                                                              <a href="<?=base_url()?>gram/index/<?=$uri - 1?>" class="page-link">←</a>
                                                          </li>
                                                      	<?php } ?>
                                                      
                                                      	<?php for($i = 0; $i < ceil($count/100); $i++) { ?>
                                                          <li class="page-item">
                                                              <a href="<?=base_url()?>gram/index/<?=$i+1?>" class="page-link"><?=$i+1?></a>
                                                          </li>
													  	<?php } ?>
    ...
    <div class="modal fade" id="editsubadmin" tabindex="-1" aria-labelledby="exampleModalgridLabel" aria-modal="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalgridLabel">Edit Gram Details</h5>
...
<script>
    ...
    $(document).on('submit', '#addgrampanchayat', function(ev) {
      ...
      var gram_name = $('#gram_name').val();
       
        if (panchayatsamiti == '') {
            $('#pan_sam_nameError').html('Select Panchayat Samiti Name');
            $('.error').css('color', 'red');
            error = true;
            // alert("hi");
        }
      if (gram_pan_name == '') {
            $('#gram_pan_Error').html('Enter Gram Panchayat Name');
            $('.error').css('color', 'red');
            error = true;
            // alert("hi");
        }
      ...
      if (gram_name == '') {
            $('#gram_name_Error').html('Enter Gram Name');
            $('.error').css('color', 'red');
            error = true;
            // alert("hi");
        }
            ...
            $.ajax({
                ...
                success: function(result) {
                    ...
                    if (dataResult.done == '1') {
                        swal('Gram Added 🙂', ' ', 'success');
                        setTimeout(function() {
                            location.reload(true);
                        }, 1000);
                    }
                    if (dataResult.done == '0') {
                        swal('Gram Not Added ☹️', ' ', 'success');
                        setTimeout(function() {
                            location.reload(true);
                        }, 1000);
                    }
                    if (dataResult.email == '0') {
                        swal('Gram Already Exist ☹️', ' ', 'error');
                    }
                },
                cache: false,
                contentType: false,
