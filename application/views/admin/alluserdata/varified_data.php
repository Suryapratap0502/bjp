                    ...
                    <div class="card">
                        <div class="card-header align-items-center d-flex">
                            ...
                            <div class="flex-shrink-0 showdata">
								<span type="button" class="badge align-middle ms-1 unvarify" data-id="not_varified" style="border: 2px solid blue; color:blue;">Unvarify</span>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row align-items-center mt-4 pt-2 justify-content-between d-flex">
                                ...
                                <div class="col-md-8">
                                    ...
                                    if ($uri > 1) { ?>
                                        <a href="<?= base_url() ?>userdata/index/<?= $uri - 1 ?>" class="page-link">←</a>
                                    <?php } ?>

                                    <?php for ($i = 0; $i < ($count / 500); $i++) { ?>
                                        <a href="<?= base_url() ?>userdata/index/<?= $i + 1 ?>" class="page-link">
                                            <?= $i + 1 ?>
                                        </a>
                                    <?php } ?>
        ...
        $(".unvarify").click(function() {
            ...
            if (confirm("are you sure you want to " + action)) {
                ...
                if (arr_id.length == 0) {
                    ...
                    $.ajax({
                        url: "<?= base_url('userdata/not_varifydata'); ?>",
                        type: 'post',
                        data: {
                            action: action,
                            id: arr_id
